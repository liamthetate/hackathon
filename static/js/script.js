...
scene("start", () => {
  ...
  let firstInstruction = add([
    text("Press Enter key to begin", 12),
    pos(width() / 2, 180),
    origin("center"),
    color(rgb(1, 1, 1))
  ]);
  ...
  keyPress("enter", () => {
    ...
    add([
      text("Press Space key to start Game", 12),
      pos(width() / 2, 140),
      origin("center"),
      color(rgb(1, 1, 1))
    ]);
    add([
      text("Press C key to view the cards", 12),
      pos(width() / 2, 180),
      origin("center"),
      color(rgb(1, 1, 1))
    ]);
    add([
      text("Press L key to view the leaderboards", 12),
      pos(width() / 2, 220),
      origin("center"),
      color(rgb(1, 1, 1))
    ]);
    add([
      text("Press S key to view story", 12),
      pos(width() / 2, 260),
      origin("center"),
      color(rgb(1, 1, 1))
    ]);
